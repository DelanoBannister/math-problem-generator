...
function simpleAdditionProblem() {
    ...
    return MathProblem(
        ...
        wrongAnswer1 = left + right + 1,
        wrongAnswer2 = left * right, 
        wrongAnswer3 = left + right + 10);
}
...
module.export= simpleAdditionProblem, quotientWithSymbolProblem, equationProblem;